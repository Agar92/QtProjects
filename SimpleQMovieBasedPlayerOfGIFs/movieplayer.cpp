...
void MoviePlayer::updateFrameSlider()
{
    ...
    qDebug() << "Number of frames: " << movie->frameCount();
    ...
    if (hasFrames) {
        ...
        frameLabel->setText(tr("Current frame: %1").arg(QString::number(movie->currentFrameNumber())));
...
void MoviePlayer::createButtons()
{
    ...
    quitButton->setShortcut(tr("Escape"));
